# Hayoung Nam
# Project 1 Basebal team management program
# June 30 2020
# Create a program that lets the manager of baseball team track the data
# Manager can specify and display the lineup for baseball games.
...
class Baseball:
    def __init__(files):
        ...
        files.database = files.data_driver.load_from_file("BaseBallPlayers.txt")
